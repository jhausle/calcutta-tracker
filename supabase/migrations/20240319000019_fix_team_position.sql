...
BEGIN
  ...
  -- Winners always advance to ceiling(game_number/2) in next round
  next_game_number := ceiling(current_game_number / 2.0);
  -- If game number is 1-2, team1 in next game, if 3-4, team2 in next game, etc.
  should_be_team1 := (ceiling(current_game_number / 2.0) = next_game_number);
