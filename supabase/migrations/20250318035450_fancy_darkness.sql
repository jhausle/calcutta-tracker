/*
  # Fix 2025 Team Purchase Prices

  1. Changes
    - Multiply all 2025 team purchase prices by 100 to correct values
    - Update season prize pool to match new total
    
  2. Details
    - Only affects 2025 season teams
    - Maintains data integrity
    - Updates season prize pool automatically
*/
