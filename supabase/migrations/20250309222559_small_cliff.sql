/*
  ...
  1. Changes
    - Converts stored procedure to a function for RPC compatibility
...
-- Function to advance winners to the next round
...
GRANT EXECUTE ON FUNCTION advance_to_next_round(UUID, UUID) TO authenticated;