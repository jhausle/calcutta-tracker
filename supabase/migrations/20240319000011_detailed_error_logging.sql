...
BEGIN
  ...
  -- First, verify the parameters and check permissions
  debug_info := jsonb_build_object(
    ...
    'has_update_permission', (SELECT has_table_privilege(current_user, 'games', 'UPDATE'))
  );
  ...
  -- Add detailed game state to debug info
